...
// this is the fragment class we don't write it from scratch we just modify it to match our class which we want to view in the recycler view
...
public class DishFragment extends Fragment {
    ...
    public static DishFragment newInstance(String mDishName, String mPrice , String mIngredients) {
